...
void (*compute_ptr[10])(float *, float *, float *, int, int, int, int) ={compute_1, compute_2, compute_3, compute_4, compute_5, compute_6, compute_7, compute_8, compute_9, compute_10};
