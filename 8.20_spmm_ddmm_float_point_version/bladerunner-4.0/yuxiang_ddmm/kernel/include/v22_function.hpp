#ifndef __V22_FUNCTION_HPP
#define __V22_FUNCTION_HPP
#include <cstdint>
#include <cstring>
...
template <typename TA, typename TB, typename TC>
int  __attribute__ ((noinline)) matrix_multiply_group_v22(TA *A, TB *B, TC *C, // matrix multiplication for v3, v3 implement the data distribution along column side, without scratchpad
